...
//   //   let products = productsData.filter((product)=>id!==product.id);
...
//   //         return <ProductCard product={element} del={deleteProduct}/>
//   //       })}
//   //     </div>
//   //   </div>
//   // )
...
//   const deleteProduct = (id)=>{
//     let products = productsData.filter((product)=>product.id!==id);
//     setProductsData(products);
//   }
...
const App = () => {
  ...
  return (
    <div>
      <h1>Data is rendering</h1>
      <div className="flex flex-row p-2 flex-wrap gap-3 justify-items-center-safe">
        {products.map((elem)=>{
         return <ProductCard key = {elem.id} product = {elem} del = {deleteProduct}/>
        })}
      </div>
